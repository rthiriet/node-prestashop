...
RESTapi.prototype.getRest = function(operation,parserToUse,instance) {
    var self = this,
        APIheader = {'authorization': 'Basic ' + process.env.PRESTASHOPAPIKEYBASE64};
    ...
    switch (parserToUse) {
     case 'image':
         self.APIoptions={decoding:"buffer", headers : APIheader};

     break;
     case 'xml':
         self.APIoptions={parser:rest.parsers.xml, headers : APIheader};
     break;
     default:
         self.APIoptions={parser:rest.parsers.xml, headers : APIheader};
     break;
